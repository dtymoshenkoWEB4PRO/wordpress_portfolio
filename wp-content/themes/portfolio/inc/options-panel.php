...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'General Fields', 'your-textdomain-here' ),
		'id'               => 'basic',
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Contact Us', 'your-textdomain-here' ),
		'id'               => 'basic-contacts',
		'subsection'       => true,
	...
	'fields'           => array(
			array(
				'id'       => 'mobile_number',
				'type'     => 'text',
				'title'    => esc_html__( 'Mobile', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Mobile', 'your-textdomain-here' ),
				'default'  => '',
			),
			array(
				'id'       => 'email',
		...
		array(
			'id'       => 'copyright',
			'type'     => 'text',
			'title'    => esc_html__( 'Copyright ', 'your-textdomain-here' ),
			'desc'     => esc_html__( 'Copyright', 'your-textdomain-here' ),
			'default'  => '',
		),
			array(
				'id'       => 'about-us',
