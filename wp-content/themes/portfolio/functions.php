...
//	wp_enqueue_style( 'portfolio-dark', get_template_directory_uri().'/assets/css/dark.css', array(), _S_VERSION );
	...
	wp_enqueue_style( 'portfolio-ie7', get_template_directory_uri().'/assets/css/ie7.css', array(), _S_VERSION );
